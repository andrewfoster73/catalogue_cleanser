...
class NavigationHelperTest < ActionView::TestCase
  ...
  test 'active navigation link' do
    html = <<~HTML.squish
      ...
      href="/products"><svg class="text-gray-300 mr-2 flex-shrink-0 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" 
  ...
  test 'inactive navigation link' do
    html = <<~HTML.squish
      ...
      href="/products"><svg class="text-gray-400 group-hover:text-gray-300 mr-2 flex-shrink-0 h-6 w-6" 
