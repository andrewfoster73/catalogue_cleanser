...
class Button::ComponentTest < ViewComponent::TestCase
  ...
  test 'with options' do
    assert_equal(
      %(<button id="view" type="button" title="path" class="text-white bg-sky-600 hover:bg-sky-700 focus:ring-sky-200 inline-flex items-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2" data-action="click-&gt;resource#navigate" data-resource-url-param="path">
